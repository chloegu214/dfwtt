...
const roundRobinResults = [
 // 2026 Results
 {
    ...
    classA: [
      ...
      { rank: 4, name: "Dennis Fang" },
      { rank: 5, name: "Max Dillow" }, 
      { rank: 6, name: "Allen Chuang" },
    ...
    classB: [
      ...
      { rank: 4, name: "Mark Sabedra" },
      { rank: 5, name: "Kuntal Pal" },
     ],
    classC: [
      { rank: 1, name: "Robert West" },
      { rank: 2, name: "Sherrief Osmi" },
      { rank: 3, name: "Franklin Du" },
      { rank: 4, name: "Markie Sabedra" },
      { rank: 5, name: "Chloe Gu" },
     ],    
 },     
 {
    date: "2026-09-06",  
    classA: [
      ...
      { rank: 4, name: "Ishan Jain" },
      { rank: 5, name: "Allen Chuang" }, 
      { rank: 6, name: "Travis Qualls" },
      { rank: 7, name: "Nicholas Senturia" },       
     ],
    classB: [
      { rank: 1, name: "Takatoshi Mii" },
      { rank: 2, name: "Mark Sebedra" },
      { rank: 3, name: "Rick Liou" },
      { rank: 4, name: "Ademayowa Owobamirin" },
      { rank: 5, name: "Yosef Lender" },
      { rank: 6, name: "Chetan Kokil" },
      { rank: 7, name: "Kuntal Pal" },
      { rank: "8-9", name: "Nicholas Lee, David Williams" },
      { rank: 10, name: "Franklin Du" },
      { rank: 11, name: "Markie Sabedra" },
     ],
 },    
 {
    date: "2026-08-30",  
    classA: [
      { rank: 1, name: "Ranjit Rayamajhi" },
      { rank: 2, name: "Max Dillow" },
      { rank: 3, name: "Ishan Jain" },
      { rank: 4, name: "Saahaj Gade" },
    ...
    classB: [
      ...
      { rank: 3, name: "Rick Liou" },
      { rank: 4, name: "Nicholas Herrera" },
      { rank: "5-6", name: "Norman Lehr, Ademayowa Owobamirin" },
      { rank: 7, name: "Tyler Russell" },
      { rank: 8, name: "Sushanta Rai" },
      { rank: 9, name: "Kuntal Pal" },
      { rank: 10, name: "Raymond Sacco" },
      { rank: 11, name: "Franklin Du" },
      { rank: "12-13", name: "David Williams, Sumin Parajuli" },
     ],
 },    
 {
    date: "2026-08-23",  
    classA: [
      ...
      { rank: "6-7", name: "Max Dillow, Arjun Dharangaonkar" }, 
      { rank: 8, name: "Saahaj Gade" }, 
      { rank: "9-10", name: "Jeremy Sneeden, Amir Dan" },       
     ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      { rank: 2, name: "Rick Liou" },
      { rank: 3, name: "Takatoshi Mii" },
      { rank: 4, name: "Travis Qualls" },
      { rank: 5, name: "Mark Sabedra" },
      { rank: 6, name: "Ademayowa Owobamirin" },
      { rank: 7, name: "Kanika Dusad" },
      { rank: 8, name: "Norman Lehr" },
      { rank: "9-10", name: "David Williams, Markie Sabedra" },
      { rank: 11, name: "Garrett Hallstrom" },
      { rank: 12, name: "Chloe Gu" },
     ],
 },   
 {
    date: "2026-08-16",  
    classA: [
      { rank: "1-2", name: "Seth Pech, Dhruv Dusad" },
      { rank: "3-4", name: "Ranjit Rayamajhi, Keith Pech" },
      { rank: "5-6", name: "Pratyush Mohanty, Vihaan Desaraju" },
      { rank: "7-8", name: "Max Dillow, Ishan Jain" },
      { rank: "9-10", name: "Saahaj Gade, Amir Dan" }, 
      { rank: 11, name: "Travis Qualls" }, 
      { rank: 12, name: "Yizhou Zhao" },       
    ],
    classB: [
      { rank: 1, name: "Takatoshi Mii" },
      { rank: 2, name: "Allen Chuang" },
      { rank: 3, name: "Mark Sabedra" },
      { rank: "4-6", name: "Norman Lehr, Yosef Lender, Kanika Dusad" },
      { rank: 7, name: "Akash Krishnamurthy" },
      { rank: "8-9", name: "David Willams, Markie Sabedra" },
     ],
 },   
 {
    date: "2026-08-09",  
    classA: [
      { rank: "1-2", name: "Keith Pech, Dhruv Dusad" },
      { rank: "3-4", name: "Ranjit Rayamajhi, Yiyang Wang" },
      { rank: "5-6", name: "Max Dillow, Ivan Tsai" },
      { rank: 7, name: "Saahaj Gade" },
      { rank: 8, name: "Alex Segesta" }, 
     ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      ...
      { rank: 5, name: "Mark Sabedra" },
      { rank: "6-7", name: "Yosef Lender, Zhongming Liu" },
      { rank: 8, name: "Paul Thai" },
      { rank: 9, name: "Nathan Clark" },
      { rank: 10, name: "Markie Sabedra" },
     ],
 },   
 {
    date: "2026-08-02",  
    classA: [
      ...
      { rank: 3, name: "Ranjit Rayamajhi" },
      { rank: "4-5", name: "Dhruv Dusad, Zhongxu An" },
      { rank: 6, name: "Ivan Tsai" }, 
      { rank: 7, name: "Arjun Dharangaonkar" },
      { rank: "8-9", name: "Max Dillow, Amir Dan" },
     ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      { rank: 2, name: "Takatoshi Mii" },
      { rank: 3, name: "Travis Qualls" },
      { rank: 4, name: "Ademayowa Owobamirin" },
      { rank: "5-8", name: "Chetan Kokil, Sushanta Rai, Mark Sabedra, Norman Lehr" },
      { rank: 9, name: "Maxwell Pham" },
      { rank: 10, name: "Yosef Lender" },
      { rank: 11, name: "Sumin Parajuli" },
      { rank: "12-13", name: "Kuntal Pal, Connie Phan" },
      { rank: 14, name: "Nicholas Herrera" },    
     ],
 },   
 {
    date: "2026-07-26",  
    classA: [
      ...
      { rank: 5, name: "Zhongxu An" }, 
      { rank: 6, name: "Pratyush Mohanty" },
      { rank: 7, name: "Yizhou Zhao" },
      { rank: 8, name: "Max Dillow" },
      { rank: "9-10", name: "Yiyang Wang, Amir Dan" }, 
    ],
    classB: [
      { rank: "1-2", name: "Takatoshi Mii, Travis Qualls" },
      { rank: "3-4", name: "Allen Chuang, Norman Lehr" },
      { rank: "5-6", name: "Yosef Lender, Chetan Kokil" },
      { rank: "7-8", name: "Mohit Chandra Kanti, Sushanta Rai" },
      { rank: 9, name: "Raymond Sacco, Kuntal Pal" },
      { rank: 10, name: "Paul Thai" },
      { rank: "11-12", name: "Nicholas Herrera, Sumin Parajuli" },     
     ],
 },   
 {
    date: "2026-07-19",  
 ...
 },   
 {
    ...
    classA: [
      ...
      { rank: "3-4", name: "Keith Pech, Yiyang Wang" },
      { rank: 5, name: "Yizhou Zhao" },
      { rank: 6, name: "Max Dillow" }, 
      { rank: 7, name: "Qihao Lin" },
      { rank: 8, name: "Amir Dan" }, 
    ],
    classB: [
      { rank: "1-2", name: "Takatoshi Mii, Allen Chuang" },
      { rank: "3-4", name: "Norman Lehr, Ademayowa Owobamirin" },
      { rank: "5-6", name: "Mohit Kanti, Travis Qualls" },
      { rank: 7, name: "Chetan Kokil" },
      { rank: 8, name: "Kuntal Pal" },
      { rank: 9, name: "Pavani Vishnubhotla" },
     ],
 },   
 {
    date: "2026-07-05",  
    classA: [
      ...
      { rank: 2, name: "Allen Chuang" },
      { rank: 3, name: "Amir Dan" },
      { rank: 4, name: "Yiyang Wang" },
    ],
    classB: [
      { rank: 5, name: "Takatoshi Mii" },
      { rank: 6, name: "Norman Lehr" },
      { rank: 7, name: "Luke Want" },
      { rank: 8, name: "Raymond Sacco" },
      { rank: 9, name: "Nathan Clark" },
      { rank: 10, name: "Pavani Vishnubhotla" },
     ],
 },   
 {
    date: "2026-06-28",  
    classA: [
      ...
      { rank: "4-5", name: "Ranjit Rayamajhi, Keith Pech" },
      { rank: "6-7", name: "Arjun Dharangaonkar, Ivan Tsai" }, 
      { rank: 8, name: "Vedanth Aswin" },
      { rank: 9, name: "Kanika Dusad" }, 
      { rank: 10, name: "Aswin Muthukumar" }, 
      { rank: 11, name: "Chetan Kikil" },                               
    ],
    classB: [
      { rank: 1, name: "Josef Lender" },
      { rank: 2, name: "Kuntal Pal" },
      { rank: 3, name: "Akash Krishnamurthy" },
      { rank: 4, name: "Raymond Sacco" },
      { rank: 5, name: "David Williams" },
      { rank: 6, name: "Pavani Vishnubhotla" },
     ],
 },   
 {
    date: "2026-06-21",  
    classA: [
      ...
      { rank: 2, name: "Ranjit Rayamajhi" },
      { rank: "3-4", name: "Pratyush Mohanty, Ivan Tsai" },
      { rank: 5, name: "Arjun Dharangaonkar" },
      { rank: "6-7", name: "Yizhou Zhao, Max Dillow" }, 
      { rank: 8, name: "Kanika Dusad" },            
    ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      { rank: 2, name: "Takotoshi Mii" },
      { rank: 3, name: "Amir Dan" },
      { rank: 4, name: "Raymond Sacco" },
      { rank: 5, name: "David Williams" },
      { rank: 6, name: "Ryan Kattady" },
      { rank: 7, name: "Annie Xiang" },
     ],
 },   
 {
    date: "2026-06-14",  
    classA: [
      { rank: 1, name: "Seth Pech" },
      { rank: 2, name: "Keith Pech" },
      { rank: "3-4", name: "Ranjit Rayamajhi, Dhruv Dusad" },
      { rank: "5-6", name: "Pratyush Mohanty, Yizhou Zhao" },
      { rank: 7, name: "Amir Dan" }, 
      { rank: 8, name: "Yiyang Wang" },            
    ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      { rank: 2, name: "Qihao Lin" },
      { rank: 3, name: "Kanika Dusad" },
      { rank: "4-5", name: "Mark Sabedra, Chetan Kokil" },
      { rank: 6, name: "Travis Qualls" },
      { rank: 7, name: "Pralav Kumar" },
      { rank: 8, name: "Ryan Kattady" },
      { rank: 9, name: "Kuntal Pal" },
     ],
 },   
 {
    date: "2026-06-07",  
    classA: [
      { rank: "1-2", name: "Seth Pech, Keith Pech" },
      { rank: "3-4", name: "Ranjit Rayamajhi, Dhruv Dusad" },
      { rank: "5-8", name: "Pratyush Mohanty, Ivan Tsai, Yizhou Zhao, Maxwell Dillow" },
      { rank: "9-11", name: "Saheb Bhatia, Amir Dan, Arjun Dharangaonkar" },
      { rank: 12, name: "Kanika Dusad" },      
    ],
    classB: [
      { rank: 1, name: "Takatoshi Mii" },
      { rank: 2, name: "Mark Sabedra" },
      { rank: "3-4", name: "Allen Chuang, Yiyang Wang" },
      { rank: "5-6", name: "Mohit Kanti, Norman Lehr" },
      { rank: 7, name: "Ala Alzubi" },
      { rank: 8, name: "Chetan Kokil" },
      { rank: 9, name: "Akash Krishnamurthy" },
      { rank: 10, name: "Kuntal Pal" },
      { rank: 11, name: "Srisaran Vasanthavada" },      
    ],
 },   
 {
    date: "2026-05-31",  
    classA: [
      ...
      { rank: 2, name: "Keith Pech" },
      { rank: "3-4", name: "Ranjit Rayamajhi, Dhruv Dusad" },
      { rank: "5-6", name: "Ivan Tsai, Yizhou Zhao" },
      { rank: 7, name: "Pratyush Mohanty" },
    ...
    classB: [
      ...
      { rank: "4-5", name: "Qihao Lin, Norman Lehr" },
      { rank: 6, name: "Amir Dan" },
      { rank: 7, name: "Kuntal Pal" },
      { rank: 8, name: "Raymond Sacco" },
      { rank: "9-10", name: "Rudransh Sinha, Srisaran Vasanthavada" },
    ],
 },   
 {
    date: "2026-05-24",  
    classA: [
      { rank: 1, name: "Seth Pech" },
      { rank: 2, name: "Ranjit Rayamajhi" },
      { rank: 3, name: "Ivan Tsai" },
      { rank: "4-5", name: "Maxwell Dillow, Yizhou Zhao" },
      { rank: 6, name: "Saahaj Gade" },
      { rank: 7, name: "Austin Clemens" },      
    ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      { rank: 2, name: "Yiyang Wang" },
      { rank: "3-4", name: "Travis Qualls, Chetan Kokil" },
      { rank: 5, name: "Akash Krishnamurthy" },
      { rank: "6-7", name: "Raymond Sacco, David Williams" },
    ],
 },   
 {
    date: "2026-05-17",  
    classA: [
      ...
      { rank: "4-6", name: "Ranjit Rayamajhi, Pratyush Mohanty, Yizhou Zhao" },
      { rank: "7-9", name: "Michael Chang, Maxwell Dillow, Saahaj Gade" },
    ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      { rank: 2, name: "Travis Qualls" },
      { rank: "3-4", name: "Ademayowa Owobamirin, Chetan Kokil" },
      { rank: 5, name: "Raymond Sacco" },
      { rank: 6, name: "David Williams" },
      { rank: "7-8", name: "Kuntal Pal, Amir Dan" },     
    ],
 },   
 {
    date: "2026-05-10",  
 ...
 },   
 {
    ...
    classA: [
      { rank: 1, name: "Seth Pech" },
      { rank: 2, name: "Keith Pech" },
      { rank: "3-4", name: "Dhruv Dusad, Vihaan Desaraju" },
      { rank: "5-6", name: "Ranjit Rayamajhi, Maxwell Dillow" },
      { rank: "7-8", name: "Allen Chuang, Arjun Dharangaonkar" },
    ],
    classB: [
      { rank: 1, name: "Saahaj Gade" },
      { rank: 2, name: "Kanika Dhruv" },
      { rank: 3, name: "Vedanth Aswin" },
      { rank: "4-6", name: "Sandesh Basnet, Chetan Kokil, Amir Dan" },
      { rank: "7-8", name: "Masood Hyder, Doug Zhuang" },
      { rank: 9, name: "Kuntal Pal" },      
    ],
 },   
 {
    ...
    classA: [
      { rank: 1, name: "Dhruv Dusad" },
      { rank: 2, name: "Saahaj Gade" },
      { rank: "3-4", name: "Ranjit Rayamajhi, Yizhou Zhao" },
      { rank: 5, name: "Kanika Dusad" },
      { rank: 6, name: "Vedanth Aswin" },
      { rank: "7-8", name: "Maxwell Dillow, Amir Dan" },                      
    ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      { rank: 2, name: "Travis Qualls" },
 ...
 },   
 {
    date: "2026-04-12",  
    classA: [
      { rank: "1-2", name: "Keith Pech, Pratyush Mohanty" },
      { rank: "3-4", name: "Ranjit Rayamajhi, Maxwell Dillow" },
      { rank: "5-6", name: "Amir Dan, Cole Ryberg" },
      { rank: "7-8", name: "Advik Pradhan, Takatoshi Mii" },          
    ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      { rank: 2, name: "Sandesh Pandit" },
      { rank: 3, name: "Ademayowa Owobamirin" },
      { rank: "4-5", name: "Aravind Parthasarathy, Chetan Kokil" },
      { rank: 6, name: "Kapil Mitra Tewari" },
      { rank: "7-8", name: "Kuntal Pal, David Williams" },
    ],
 },   
 {
    date: "2026-03-29",  
    classA: [
      ...
      { rank: 4, name: "Masood Hyder" },          
      { rank: "5-6", name: "Doug Zhuang, Saahaj Gade" },
      { rank: 7, name: "Amir Dan" },
      { rank: 8, name: "Ademayowa Owobamirin" },      
    ],
    classB: [
      { rank: "1-3", name: "Allen Chuang, Takatoshi Mii, Travis Qualls" },
      { rank: 4, name: "Norman Lehr" },
      { rank: 5, name: "Aravind Parthasarathy" },
      { rank: "6-7", name: "Vivaan Ubale, Srisaran Vasanthavada" },
      { rank: 8, name: "Shrreshth Shan" },
      { rank: "9-10", name: "Ryan Kattady, David Williams" },
    ],
 },   
 {
    date: "2026-03-22",  
    classA: [
      { rank: 1, name: "Ranjit Rayamajhi" },
      { rank: 2, name: "Yizhou Zhao" },
      { rank: "3-4", name: "Masood Hyder, Yiyang Wang" },     
      { rank: "5-6", name: "Maxwell Dillow, Ivan Tsai" },
      { rank: "7-8", name: "Jack Liau, Amir Dan" },
    ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      ...
      { rank: 6, name: "Touradj Solouki" },
      { rank: 7, name: "Kuntal Pal" },
      { rank: "8-9", name: "Rita Zhao, Nicholas Lee" },       
    ],
 },   
 {
    date: "2026-03-08",  
 ...
 },   
 {
    ...
    classB: [
      ...
      { rank: "4-6", name: "Travis Qualls, Takatoshi Mii, Aravind Parthasarathy" },
      { rank: 7, name: "Allen Chuang" },
      { rank: 8, name: "Norman Lehr" },
      { rank: 9, name: "Mia Li" }, 
      { rank: 10, name: "Ernest Lu" },          
    ],
 },   
 {
    date: "2026-02-22",  
    classA: [
      { rank: 1, name: "Ranjit Rayamajhi" },
      { rank: 2, name: "Maxwell Dillow" },
      { rank: 3, name: "Sergei Chichagov" },     
      { rank: 4, name: "Doug Zhuang" },
      { rank: 5, name: "Amir Dan" },
    ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
  ...
  },  
  {
    ...
    classA: [
      { rank: 1, name: "Keith Pech" },
      { rank: 2, name: "Ranjit Rayamajhi" },
      { rank: "3-4", name: "Dhruv Dusad, Pratyush Mohanty" },     
      { rank: "5-6", name: "Yizhou Zhao, Maxwell Dillow" },
      { rank: "7-8", name: "Sergei Chichagov, Nicholas Senturia" },
    ],
    classB: [
      { rank: 1, name: "Kanika Dusad" },
      { rank: 2, name: "Allen Chuang" },
      { rank: "3-4", name: "Ademayowa Owobamirin, Amir Dan" },
      { rank: 5, name: "Takatoshi Mii" },
      { rank: "6-7", name: "Norman Lehr, Raj Kumar Vigrahala" },
    ],
  },  
  {
    date: "2026-02-08",  
    classA: [
      ...
      { rank: "5-6", name: "Yizhou Zhao, Nicholas Senturia" },
      { rank: 7, name: "Mosood Hyder" },     
      { rank: 8, name: "Maxwell Dillow" },
    ],
    classB: [
      { rank: "1-2", name: "Doug Zhuang, Saheb Bhatia" },
      { rank: "3-4", name: "Travis Qualls, Norman Lehr" },
      { rank: "5-6", name: "Amir Dan, Kanika Dusad" },
      { rank: 7, name: "Saahaj Gade" },
      { rank: 8, name: "Chetan Kokil" },
    ],
  }, 
 ...
 },
 {
    ...
    classA: [
      ...
      { rank: 3, name: "Ranjit Rayamajhi" },     
      { rank: 4, name: "Pratyush Mohanty" },
      { rank: 5, name: "Sergei Chichagoy" },
    ],
    classB: [
      { rank: 1, name: "Allen Chuang" },
      { rank: "2-3", name: "Travis Qualls, Saheb Bhatia" },
      { rank: "4-5", name: "Takatoshi Mii, Kanika Dusad" },
      { rank: 6, name: "Michael Zhu" },
      { rank: 7, name: "Amir Dan" },
      { rank: 8, name: "Norman Lehr" },
      { rank: 9, name: "Mia Li" },
    ],
 },      
 {
    ...
    classA: [
      { rank: 1, name: "Seth Pech" },
      { rank: 2, name: "Keith Pech" },
      { rank: "3-4", name: "Vihaan Desaraju, Masood Hyder" },     
      { rank: "5-6", name: "Pratyush Mohanty, Yizhou Zhao" },
    ...
    classB: [
      { rank: 1, name: "Allen Chuang" },
      { rank: 2, name: "Saahaj Gade" },
      { rank: "3-4", name: "Takatoshi Mii, Kanika Dusad" },
      { rank: 5, name: "Amir Dan" },
      { rank: 6, name: "Ademayowa Owobamirin" },
      { rank: 7, name: "Viraaj Vemula" },
      { rank: 8, name: "Dennis Ochei" },
      { rank: 9, name: "Kuntal Pal" },
      { rank: 10, name: "Mia Li" },                       
    ],
  },      
  ...
  // 2025 Results
  {
    ...
    classA: [
      ...
      { rank: 2, name: "Vihaan Desaraju" },
      { rank: 3, name: "Ivan Tsai" },     
      { rank: "4-5", name: "Maxwell Dillow, Nicholas Senturia" },
      { rank: 6, name: "Yiyang Wang" },     
    ],
    classB: [
      { rank: 1, name: "Travis Qualls" },
      { rank: 2, name: "Takotoshi Mii" },
      { rank: "3-4", name: "Allen Chuang, Genaro Natale" },
      { rank: "5-6", name: "Norman Lehr, Yosef Lender" },
    ],
  },    
  {
    date: "2025-12-21",  
    ...
    classB: [
      ...
      { rank: 2, name: "Takotoshi Mii" },
      { rank: "3-4", name: "Travis Qualls, Norman Lehr" },
      { rank: "5-6", name: "Chetan Kokil, Yosef Lender" },
      { rank: 7, name: "Wilson Bryan" }, 
      { rank: 8, name: "Kuntal Pal" },
    ],
  },  
  {
  ...
  },
  {
    ...
    classA: [
      { rank: 1, name: "Seth Pech" },
      { rank: 2, name: "Ranjit Rayamajhi" },
      { rank: "3-4", name: "Joshua Mak, Maxwell Dillow" },     
  ...
  },
  {
    date: "2025-11-30",
    classA: [
      { rank: 1, name: "Yiyang Wang" },
      { rank: 2, name: "Nicholas Senturia" },
      { rank: 3, name: "Maxwell Dillow" },     
      { rank: 4, name: "Allen Chuang" },
      { rank: "5-6", name: "Amir Dan, Travis Qualls" },     
    ],
    classB: [
      { rank: 1, name: "Saahaj Gade" },
      { rank: 2, name: "Takatoshi Mii" },
  ...
  },       
  {
    ...
    open: [
      { rank: 1, name: "Seth Pech" },
      { rank: 2, name: "Ranjit Rayamajhi" },
      { rank: "3-4", name: "Keith Pech, Vihaan Desaraju" },
      { rank: 5, name: "Pratyush Mohanty" },
      { rank: "6-7", name: "Dhruv Dusad, Yizhou Zhao" },
      { rank: 8, name: "Nicholas Senturi" },
      { rank: 9, name: "Masood Hyder" },
      { rank: 10, name: "Maxwell Dillow" },
      { rank: 11, name: "Yiyang Wang" },
      { rank: 12, name: "Doug Zhuang" },
      { rank: 13, name: "David Williams" },
    ],
  }, 
  {
    date: "2025-11-16",
    classA: [
      ...
      { rank: 6, name: "Allen Chuang" },
      { rank: 7, name: "Dan Amir" },                
    ],
    classB: [
      { rank: 1, name: "Takatoshi Mii" },
      { rank: 2, name: "Doug Zhuang" },
      { rank: "3-4", name: "Genaro Natale, Norman Lehr" },
      { rank: "5-6", name: "Yosef Lender, Raymond Sacco" },
     ],
  },       
  {
    date: "2025-11-09",
    classA: [
      ...
      { rank: 2, name: "Keith Pech" },
      { rank: "3-4", name: "Ranjit Rayamajhi, Maxwell Dillow" },     
      { rank: "5-6", name: "Vihaan Desaraju, Travis Qualls" },
      { rank: "7-8", name: "Yizhou Zhao, Akash Sathyamurthy" },     
    ],
    classB: [
      { rank: 1, name: "Takatoshi Mii" },
      { rank: 2, name: "Ademayowa Owobamirin" },
      { rank: 3, name: "Allen Chuang" },
      { rank: 4, name: "Raj Kumar Vigrahala" },
      { rank: 5, name: "Chetan Kokil" }, 
      { rank: 6, name: "Xiang Bi" },
      { rank: 7, name: "Kuntal Pal" },
      { rank: 8, name: "Srikanth Bejjenky" }, 
      { rank: 9, name: "Raymond Sacco" },                           
    ],
  },      
  {
    date: "2025-11-02",
    classA: [
      ...
      { rank: 4, name: "Maxwell Dillow" },
      { rank: 5, name: "Steve Suh" },     
      { rank: 6, name: "Travis Qualls" },      
      { rank: 7, name: "Allen Chuang" },
      { rank: 8, name: "Doug Zhuang" },      
    ],
    classB: [
      { rank: 1, name: "Ademayowa Owobamirin" },
      { rank: 2, name: "Yosef Lender" },
      { rank: 3, name: "Raymond Sacco" },
