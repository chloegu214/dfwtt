          ...
          <Alert className="border-black-200 bg-red-50">
             <AlertDescription className="text-red-800">
              <div className="space-y-2">
                ...
                <p>
                  Heights TT location will be closed on Friday, July 3rd. 
                </p>
               </div>
            </AlertDescription>
          </Alert>
          ...
          <Alert className="border-black-200 bg-yellow-50">
              ...
              <div className="space-y-2">
                <p className="font-semibold text-lg">
                  ...
                  <p>
                   2026 DFWTT Fall Open on November 7 (Saturday) at the Cimarron Recreation Center in Irving.&nbsp;
                   <a href= "/documents/DFWTT26FallOpnR3.pdf"
