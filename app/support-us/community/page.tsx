    ...
    <div className="min-h-screen bg-gray-50 pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-purple-100 max-w-3xl mx-auto mb-8">
              DFWTT is deeply committed to promoting table tennis throughout the
              Dallas-Fort Worth metroplex through exhibitions, clinics, and
              community partnerships. We bring the sport to schools, malls,
              churches, and anywhere people gather.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our commitment to community outreach has touched thousands of
              lives across the metroplex.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Exhibition & Clinic Programs
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              DFWTT conducts exhibitions and clinics at schools, shopping malls,
              churches, and pretty much any open places to promote table tennis
              in the metroplex.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Highlights from our community outreach efforts and special
              programs.
            </p>
          </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our community efforts are powered by dedicated volunteers who
              share our passion for table tennis.
            </p>
          </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-3">
                  USATT Volunteer Coach of the Year - 2005
                </h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  In 2005, USATT and USOC recognized and awarded our Daniel
                  Rutenberg as the <strong>Volunteer Coach of the Year</strong>.
                  This prestigious award recognized his dedication to promoting
                  table tennis through countless exhibitions and free clinics in
                  schools, shopping malls, and other community venues.
                </p>
                <p className="text-gray-600 text-sm">
                  This recognition highlights DFWTT's commitment to community
                  service and the impact our volunteers make in promoting table
                  tennis throughout the metroplex.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From time to time the media has shown interest in what DFWTT does
              for the table tennis community in the metroplex.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4 text-white">
            Request an Exhibition or Clinic
          </h2>
          <p className="text-purple-100 mb-6 max-w-2xl mx-auto">
            Interested in having DFWTT conduct a table tennis exhibition or
            clinic at your school, church, or organization? Contact us to
            discuss how we can bring the excitement of table tennis to your
            community.
          </p>
